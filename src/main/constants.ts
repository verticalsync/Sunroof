...
export const DATA_DIR = process.env.SUNCORD_USER_DATA_DIR || join(app.getPath("userData"));
...
export const VENCORD_FILES_DIR =
    (require("./settings") as typeof import("./settings")).Settings.store.vencordDir || join(DATA_DIR, "suncordDist");
